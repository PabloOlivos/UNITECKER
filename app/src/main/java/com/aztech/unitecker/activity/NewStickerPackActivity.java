...
import com.aztech.unitecker.constants.ConstantsData;
import com.aztech.unitecker.utils.FileUtils;
import com.aztech.unitecker.utils.StickerPacksManager;
import com.aztech.unitecker.whatsapp_api.Sticker;
import com.aztech.unitecker.whatsapp_api.StickerContentProvider;
import com.aztech.unitecker.whatsapp_api.StickerPack;
import com.aztech.unitecker.whatsapp_api.StickerPackDetailsActivity;
...
public class NewStickerPackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validateValues()) {
                    Toast.makeText(NewStickerPackActivity.this, "Tienes que llenar todos los espacios vacíos.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        btnCreate.setOnClickListener(v -> {
            Toast.makeText(this, "Seleccione un mínimo de 3 imágenes.", Toast.LENGTH_LONG).show();
        ...
        gridview.setOnItemClickListener((parent, v, position, id) -> {
            Toast.makeText(NewStickerPackActivity.this, "Imagen removida", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.save_sticker_pack) {
            if (validateValues()) {
                Toast.makeText(this, "Tienes que llenar todos los espacios vacíos.", Toast.LENGTH_SHORT).show();
            } else {
                saveStickerPack(imageAdapter.uries, nameEdit.getText().toString(), authorEdit.getText().toString());
            }
        }
