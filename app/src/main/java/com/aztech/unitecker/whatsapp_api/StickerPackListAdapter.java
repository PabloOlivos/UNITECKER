...
package com.aztech.unitecker.whatsapp_api;
...
import com.aztech.unitecker.activity.MyStickersFragment;
...
public class StickerPackListAdapter extends RecyclerView.Adapter<StickerPackListItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final StickerPackListItemViewHolder viewHolder, final int index) {
        ...
        viewHolder.filesizeView.setText(FileUtils.getFolderSizeLabel(ConstantsData.STICKERS_DIRECTORY_PATH + pack.identifier));
