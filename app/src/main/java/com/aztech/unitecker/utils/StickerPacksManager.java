package com.aztech.unitecker.utils;
...
import com.aztech.unitecker.whatsapp_api.ContentFileParser;
...
public class StickerPacksManager {
    ...
    public static List<StickerPack> getStickerPacks(Context context) {
        ...
        if (PermissionsHelper.verifyPermissions(context)) {
            File contentFile = new File(ConstantsData.STICKERS_DIRECTORY_PATH + "contents.json");
    ...
    public static void saveStickerPacksToJson(StickerPacksContainer container) {
        ...
        try {
            File file = new File(ConstantsData.STICKERS_DIRECTORY_PATH + "/contents.json");
    ...
    public static void deleteStickerPack(int index) {
        ...
        FileUtils.deleteFolder(ConstantsData.STICKERS_DIRECTORY_PATH + pack.identifier);
